...
- **로컬 이미지 생성** — SDXL 5종 (Animagine · Illustrious · NoobAI · Pony · RealVis) + **FLUX.1-dev Abliterated(무검열 GGUF, Q8 기본 · 1536² 네이티브)** + Chroma, ComfyUI 백엔드 + 초간단 웹 페이지 (대량 100/1000장 배치 · Ultimate SD Upscale 4K)
